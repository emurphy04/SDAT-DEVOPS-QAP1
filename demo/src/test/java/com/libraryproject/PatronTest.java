...
public class PatronTest {
    ...
    public void testSettersAndAddToList() {
        ...
        String expected = "Tyra White is an employee, | 7096313003 | 10 Hawker Cres | Borrowed: , Hunger Games";
        assertEquals(expected, patron.toString());

        // Test adding multiple items to the list
        patron.addToList("Harry Potter");
        expected = "Tyra White is an employee, | 7096313003 | 10 Hawker Cres | Borrowed: , Hunger Games, Harry Potter";
        assertEquals(expected, patron.toString());
    }
}
